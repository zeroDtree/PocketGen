...
def from_protein_ligand_dicts(
    protein_dict=None, ligand_dict=None, residue_dict=None, seq=None, full_seq_idx=None, r10_idx=None
):
    instance = {}
...
class PocketLigandPairDataset(Dataset):
    ...
    def __init__(self, raw_path, transform=None):
        ...
        self.processed_path = os.path.join(
            os.path.dirname(self.raw_path), os.path.basename(self.raw_path) + "_processed.lmdb"
        )
        self.name2id_path = os.path.join(
            os.path.dirname(self.raw_path), os.path.basename(self.raw_path) + "_name2id.pt"
        )
